...
class BasePromptTemplate(ABC):
    """Base prompt template. Inherit it to write OpenAI messages and functions."""
    ...
    @classmethod
    def load(cls, obj: Union[Dict, str]) -> Optional["BasePromptTemplate"]:
    ...
    @classmethod
    def _from_json(cls, json_path: str) -> Optional["BasePromptTemplate"]:
    ...
    def _write_json(self, data: Dict, path: str) -> None:
        """Write a JSON file."""
        # Sometimes `name` in `MessageTemplate` is null`
